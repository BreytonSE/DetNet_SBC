...
public class SystemAlert1_StepDefn {
    private final PageObjectManager pageObjectManager;

    public SystemAlert1_StepDefn() {
...
//       Continue with validation regardless
    ...
    @When("the user creates a condition that triggers the Acknowledgement Alert alert")
    public void the_user_creates_a_condition_that_triggers_the_acknowledgement_alert_alert() {
        DashboardPageObjectModel dashboardPageObjectModel = pageObjectManager.getDashboardPageObjectModel();
        DashboardValidation dashboardValidation = new DashboardValidation(dashboardPageObjectModel);
        dashboardPageObjectModel.openAlertDropDown();

        String expectedAlert = "Acknowledgement Alert";
        boolean alertAlreadyPresent = dashboardPageObjectModel.getAllCurrentDeviceAlerts()
                .stream()
                .anyMatch(alert -> alert.equalsIgnoreCase(expectedAlert));
...
//       Continue with validation regardless
        dashboardPageObjectModel.refreshBrowserTab();
        dashboardPageObjectModel.openAlertDropDown();
        dashboardValidation.validateCurrentDeviceAlert("Acknowledgement Alert");
        SoftAssertionUtils.getSoftAssertions().assertAll();
    }
...
//       Continue with validation regardless
    ...
    @When("the user creates a condition that triggers the Blast Voltage Bad alert")
    public void the_user_creates_a_condition_that_triggers_the_blast_voltage_bad_alert() {
        DashboardPageObjectModel dashboardPageObjectModel = pageObjectManager.getDashboardPageObjectModel();
        DashboardValidation dashboardValidation = new DashboardValidation(dashboardPageObjectModel);
        dashboardPageObjectModel.openAlertDropDown();

        String expectedAlert = "Blast Voltage Bad";
        boolean alertAlreadyPresent = dashboardPageObjectModel.getAllCurrentDeviceAlerts()
                .stream()
                .anyMatch(alert -> alert.equalsIgnoreCase(expectedAlert));
...
//       Continue with validation regardless
        dashboardPageObjectModel.refreshBrowserTab();
        dashboardPageObjectModel.openAlertDropDown();
        dashboardValidation.validateCurrentDeviceAlert("Blast Voltage Bad");
        SoftAssertionUtils.getSoftAssertions().assertAll();
    }

    @When("the user refreshes the page after verifying the Blast Voltage Bad alert")
    public void the_user_refreshes_the_page_after_verifying_the_blast_voltage_bad_alert() {
        DashboardPageObjectModel dashboardPageObjectModel = pageObjectManager.getDashboardPageObjectModel();
        dashboardPageObjectModel.refreshBrowserTab();
    }
